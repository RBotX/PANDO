...
####################################################################################################
save(mshared,file="mshared_nonlinear.rda")
save(perTaskModels,file="ptb_nonlinear.rda")
...
PlotImp(dff1,flip = TRUE,signalVars = 1:11)
dev.copy2eps(file="plots/NonLinearFeatureImportancePANDO.eps")

dff2 = PerTaskImportances(perTaskModels) 
PlotImp(dff2,flip = TRUE,signalVars = 1:11)
dev.copy2eps(file="plots/NonLinearFeatureImportancePTB.eps")
...
####################################################################################################
save(mshared,file="mshared_linear.rda")
save(perTaskModels,file="ptb_linear.rda")



mshared=load("mshared_linear.rda")
perTaskModels=load(file="ptb_linear.rda")
#### plot feature importances and save locally:
#plotExperimentResults(pandoModel = mshared,perTaskModels = perTaskModels,postfix = "NonLinear",signalVars = 1:11)
dff1 = FeatureImportance.BoostingModel(mshared$fam1) 
PlotImp(dff1,flip = FALSE,signalVars = 1:11)
dev.copy2eps(file="plots/LinearFeatureImportancePANDO.eps")

dff2 = PerTaskImportances(perTaskModels) 
PlotImp(dff2,flip = FALSE,signalVars = 1:11)
dev.copy2eps(file="plots/LinearFeatureImportancePTB.eps")
